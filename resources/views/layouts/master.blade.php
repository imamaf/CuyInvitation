...
<head>
    ...
    <!--     Fonts and icons     -->
    <link rel="stylesheet" type="text/css" href="../assets/css/font-roboto.css" />
    <!-- <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css"> -->
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.1/css/all.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/cdn-datatable.min.css    "/>
    <!-- CSS Files -->
        ...
        <div class="sidebar" data-color="purple" data-background-color="white" data-image="../assets/img/sidebar-3.jpg">
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="nav-item {{ 'GuestBook' == request()->path() ? 'active' : '' }} ">
                        <a class="nav-link" href="{{url('/guestbook')}}">
                            <i class="material-icons">library_books</i>
                            <p>Buku Tamu</p>
                        </a>
                    </li>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="copyright" id="copyright">
                        <a>Copyright &copy; 2020 Cuy Invitation. All right reserved.</a>
                    </div>
                </div>
            </footer>
        </div>
