...
<html lang="zxx">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="row">
                ...
                <div class="col-md-4 blog-grid-flex">
                  <div class="clients-color">
                    <img src="{{ asset('assets/images/designc03/blog1.jpg') }}" class="img-thumbnail" alt="">
                    <div class="blog-txt-info">
 ...
 <!--Gallery-->
            ...
            <div class="row grid gallery-info">
               <div class="col-lg-4 col-md-4 col-sm-4 gallery-grids p-0">
                  <figure class="effect-selena">
                     <img src="{{ asset('assets/images/designc03/s2.jpg') }}" alt="img15"/>
                     <figcaption>
                        <h6>Lois<span> & </span> Clark</h6>
                        <p>Wedding </p>
                        <a href="{{ asset('assets/images/designc03/s2.jpg') }}"  class="lsb-preview" data-lsb-group="header" data-title="">
                        </a>
                     </figcaption>
                  </figure>
                  <figure class="effect-selena">
                     <img src="{{ asset('assets/images/designc03/s3.jpg') }}" alt="img15"/>
                     <figcaption>
                        <h6>Lois<span> & </span> Clark</h6>
                        <p>Wedding </p>
                        <a href="{{ asset('assets/images/designc03/s3.jpg') }}"  class="lsb-preview" data-lsb-group="header" data-title="">
                        </a>
                     </figcaption>
                  </figure>
               </div>
               <div class="col-lg-4 col-md-4 col-sm-4 gallery-grids p-0">
                  <figure class="effect-selena">
                     <img src="{{ asset('assets/images/designc03/gg.jpg') }}" alt="img15"/>
                     <figcaption>
                        <h6>Lois<span> & </span> Clark</h6>
                        <p>Wedding </p>
                        <a href="{{ asset('assets/images/designc03/gg.jpg') }}"  class="lsb-preview" data-lsb-group="header" data-title="">
                        </a>
                     </figcaption>
                  </figure>
                  <figure class="effect-selena">
                     <img src="{{ asset('assets/images/designc03/s1.jpg') }}" alt="img15"/>
                     <figcaption>
                        <h6>Lois<span> & </span> Clark</h6>
                        <p>Wedding </p>
                        <a href="{{ asset('assets/images/designc03/s1.jpg') }}"  class="lsb-preview" data-lsb-group="header" data-title="">
                        </a>
                     </figcaption>
                  </figure>
               </div>
               <div class="col-lg-4 col-md-4 col-sm-4 gallery-grids p-0">
                  ...
                  <figure class="effect-selena">
                     <img src="{{ asset('assets/images/designc03/s4.jpg') }}" alt="img15"/>
                     <figcaption>
                        <h6>Lois<span> & </span> Clark</h6>
                        <p>Wedding </p>
                        <a href="{{ asset('assets/images/designc03/s4.jpg') }}"  class="lsb-preview" data-lsb-group="header" data-title="">
                        </a>
                     </figcaption>
                  </figure>
               </div>
    ...
    <script>
       ...
       */
      var d = new Date('07/24/2020 05:40:00');
